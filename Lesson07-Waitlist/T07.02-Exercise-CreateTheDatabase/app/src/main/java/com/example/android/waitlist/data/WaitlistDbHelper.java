...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SQL_CREATE_WAITLIST_TABLE = "CREATE TABLE " +
                ...
                WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME + " TEXT NON NULL, " +
                WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE + " INT NON NULL, " +
                WaitlistContract.WaitlistEntry.COLUMN_TIMESTAMP + " TIMESTAMPT DEFAULT CURRENT_TIMESTAMP" +
                ");";
