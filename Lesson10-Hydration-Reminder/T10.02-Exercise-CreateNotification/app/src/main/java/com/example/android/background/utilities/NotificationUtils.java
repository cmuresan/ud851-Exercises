...
public class NotificationUtils {
    private static final int PENDING_INTENT_ID = 3125;
    private static final String WATER_NOTIFICATION_CHANNEL_ID = "notification_channel";
    private static final int WATER_NOTIFICATION_ID = 1154;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, WATER_NOTIFICATION_CHANNEL_ID)
